...
class HttpAuth {
    ...
    handleUserAuth(req, res, username, password, isValidUser, httpRoot) {
        ...
        if (authCode) {
            ...
            this._smarthome.debug('HttpAuth:handleUserAuth(): authCode successful; authCode = ' + authCode);
            ...
            this._smarthome._mgmtNode.error('HttpAuth:handleUserAuth(): authCode failed');
            return res.redirect(util.format(
