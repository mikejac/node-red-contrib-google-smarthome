...
class HttpActions {
    ...
    _execDevice(command, device, is_local) {
        ...
        if (command.hasOwnProperty('command')) {
            ...
            result = this.execCommand(curDevice, command, is_local); // Devices.execCommand
            if (result) {
        ...
        this.execDevice(curDevice, true, command.params, params, is_local); // Devices.execDevice
