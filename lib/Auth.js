...
class Auth {
    ...
    loadAuthStorage(nodeId, userDir, username) {
        ...
        try {
            ...
            if (authFile === '') {
                me.debug('Auth:loadAuthStorage(): data not persisted, create new');
                me._clearAllTokens();
            } else {
                me.debug('Auth:loadAuthStorage(): data already persisted');
                ...
                me.debug('Auth:loadAuthStorage(): me._authStorage = ' + JSON.stringify(me._authStorage));
            }
