...
class Auth {
    ...
    exchangeAuthCode(code) {
        ...
        let accessToken = this._auth.tokens[Object.keys(this._auth.tokens)[0]].accessToken;
        let refreshToken = this._auth.tokens[Object.keys(this._auth.tokens)[0]].refreshToken;
