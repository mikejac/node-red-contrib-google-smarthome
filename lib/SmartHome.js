...
class GoogleSmartHome {
    constructor(mgmtNode, nodeId, userDir, httpNodeRoot, useGoogleLogin, googleClientId, emails, username, password, accessTokenDuration, usehttpnoderoot,
        httpPath, httpPort, localScanType, localScanPort, localScanPacket, httpLocalPort, nodeRedUsesHttps, ssloffload, publicKey, privateKey, jwtkeyFile, clientid,
        ...
        this._localScanPacket       = localScanPacket;
    ...
    StartUDPDeviceScanServer() {
        const me = this;
        me.debug('Starting sevice Scan UDP server on port ' + me._localScanPort);
        ...
        me._localUDPServer.bind(me._localScanPort);
    }
    //
    //
    //
